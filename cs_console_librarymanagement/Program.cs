  ...
  public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\nMenu\n" +
                                    "1. Borrow / Return Book \n" +
                                    "2. Borrow / Return Book\n");
            }
            else
            {
        ...
        //To add Newspaper details to the Library database
        ...
        //To search Newspaper details from the Library database using Book id 
        ...
        //To borrow Newspaper details from the Library
